package com.example.min123.myweather;
...
/**
 * Created by min123 on 2016/12/7.
 */
public class GetWeatherInfoTask extends AsyncTask<String,Void,List<Map<String,Object>>>{
    ...
    private static String key="&key=b18aaabe0746eb6675d3e34bd75697f7";
    public GetWeatherInfoTask(Activity context){
        this.context=context;
        progressDialog=new ProgressDialog(context);
        progressDialog.setMessage("正在获取天气，青稍后...");
    ...
    protected void onPostExecute(List<Map<String, Object>> result) {
        ...
        if(result.size()>0){
            ...
            SimpleAdapter simpleAdapter=new SimpleAdapter(context,result,
                    ...
                    R.id.temperature,R.id.weather,R.id.date,R.id.weather,
                    R.id.weather_icon});
